...
import uia.com.menu.nodos.NodoContacto;
import uia.com.menu.nodos.NodoRecordatorio;
...
public class Nodo {
    ...
    public void setNodoRecordatorio(String opcionIn, String nomMenu, String s, String[] opcionesMenu, String s1, String s2, int tipo){
            ...
            for (int i = 1; i < this.opciones.length; i++) {
                if (opcionIn.contentEquals(this.opciones[i])) {
                    if (this.menu.containsKey(i)) {
                        if (this.menu.get(i).menu != null) {
                            ...
                            if (opcionesMenu != null) {
                                for (int j = 1; j < opcionesMenu.length; j++) {
                                    NodoRecordatorio newNodo = new NodoRecordatorio(opcionesMenu[j], s, null, s1, s2, tipo);
                        ...
                        NodoRecordatorio newNodo = new NodoRecordatorio(nomMenu, subTitulo, opciones, s1, s2, tipo);
